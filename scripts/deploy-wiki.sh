...
rm -rf .wiki-temp
git clone https://github.com/jeffery9/qwen-mcp-tool.wiki.git .wiki-temp 2>/dev/null || {
    echo "⚠️  Wiki doesn't exist yet. Creating it through GitHub..."
    # Create initial wiki page through API
    gh api repos/jeffery9/qwen-mcp-tool/wiki/pages \
        --method POST \
        -f title="Home" \
        -f body="Initializing wiki..." || true

    # Try cloning again
    git clone https://github.com/jeffery9/qwen-mcp-tool.wiki.git .wiki-temp
}
...
**Quick Links**
* [📦 NPM Package](https://www.npmjs.com/package/qwen-mcp-tool)
* [🐙 GitHub Repo](https://github.com/jeffery9/qwen-mcp-tool)
* [📋 Report Issue](https://github.com/jeffery9/qwen-mcp-tool/issues/new)
EOF

# Create footer
cat > _Footer.md << 'EOF'
---
📄 [MIT License](https://github.com/jeffery9/qwen-mcp-tool/blob/main/LICENSE) |
🔧 [Contribute](https://github.com/jeffery9/qwen-mcp-tool/blob/main/CONTRIBUTING.md) |
📦 [NPM](https://www.npmjs.com/package/qwen-mcp-tool) |
⭐ [Star on GitHub](https://github.com/jeffery9/qwen-mcp-tool)
EOF
...
echo "🔗 View at: https://github.com/jeffery9/qwen-mcp-tool/wiki"
echo ""
